/* This code is aimed to send data through UART1, the same message will be sent only 10 times.
 * UART_send.c
 *
...
int main(void)
{
	...
	static char *cadena = "Hola mundo en UART\n";
	for(int i = 0; i<10; i++){
		UART_Write_String(UART1,cadena, 19);
	}
